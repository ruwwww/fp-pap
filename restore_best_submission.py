...
def main() -> None:
    ...
    # Re-fit clean best model (266.1610)
    ...
    preds = recursive_ssm_forecast(train, test_exog, combined, trend_models, res_models, selected_lags, vix_fac=1.08, spread_fac=1.08)
    ...
    print("Clean SSM-Ensemble model (RMSE 266.16) restored to submission.csv successfully!")
